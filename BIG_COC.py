# Jacob Auman, Evan Tone, Grant H, Daniel M
# 10-24-23 - 10-26-23

# the CoC curl detector.
...
# rep_counter.py script as a big function
def COUNTCURLS(whichSideArm, angleThreshold,videoSource):
